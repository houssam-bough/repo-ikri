        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
                <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-slate-800 mb-3">Compte créé avec succès !</h3>
                    <p className="text-slate-600 leading-relaxed mb-6">
                        Votre compte est en attente d'approbation par notre équipe. Vous recevrez une notification par email dès validation.
                    </p>
                    {onSwitchToLogin && (
                        <Button onClick={onSwitchToLogin} className="w-full bg-emerald-500 hover:bg-emerald-600">
