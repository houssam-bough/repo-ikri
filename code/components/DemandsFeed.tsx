        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="text-xs text-slate-600 space-y-1">
              <p>
                {t('common.service')}: {machineType === 'all' ? t('common.allTypesMachines') : machineType}
              </p>
              <p>
                {t('common.radius')}: {radiusKm} km
              </p>
              <p className="font-semibold text-orange-600">
                {t('common.showingDemands').replace('{{showing}}', filteredDemands.length.toString()).replace('{{total}}', demands.length.toString())}
              </p>
            </div>
          </div>
        </div>
